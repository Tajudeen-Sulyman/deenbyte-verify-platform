...
const NIN: Item[] = [
  ...
  { href: '/verify?s=nin_validation', label: 'NIN Validation', d: 'M9 3h6v3H9zM9 5H7v16h10V5h-2M9 12l2 2 4-4', g: 'from-emerald-500 to-teal-600' },
];
const BVN: Item[] = [
  ...
  return (
    <>
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-3">
        ...
        <NavGroup label="Products" d="M6 3h9l4 4v14H6zM9 3v5h5" g="from-amber-500 to-orange-600" items={[{ href: '/taxid', label: 'TIN Verification Slip', d: 'M6 3h9l4 4v14H6zM9 3v5h5', g: 'from-amber-500 to-orange-600' }, { href: '/tin', label: 'Generate TIN (Agency)', d: 'M12 3l7 4v5c0 5-3.5 8-7 9-3.5-1-7-4-7-9V7l7-4z', g: 'from-pink-500 to-rose-600' }, { href: '/tin/history', label: 'TIN History', d: 'M12 8v4l3 3M21 12a9 9 0 11-9-9 9 9 0 019 9z', g: 'from-blue-500 to-indigo-600' }, { href: '/nin/modification', label: 'NIN Modification', d: 'M4 4h16v16H4zM8 10h8M8 14h5', g: 'from-teal-500 to-cyan-600' }]} active={active} onNav={onNav} />
        {isAdmin && (
