...
const OVERVIEW: Item[] = [
  ...
  { href: '/wallet', label: 'Fund Wallet', d: 'M12 8c-3 0-5 1-5 2.5S9 13 12 13s5 1 5 2.5-2 2.5-5 2.5M12 8c3 0 5 1 5 2.5M12 8V6m0 12v-2M3 10h18M3 14h18', g: 'from-green-500 to-emerald-600' },
  { href: '/profile', label: 'Profile', d: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM4 21v-1a7 7 0 0114 0v1', g: 'from-pink-500 to-rose-600' }, d: 'M3 7h18v12H3zM3 7l3-4h12l3 4M15 12h4', g: 'from-amber-500 to-orange-600' },
];
const NIN: Item[] = [
