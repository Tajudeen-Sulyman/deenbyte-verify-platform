...
const NIN: Item[] = [
  ...
  { href: '/nin/validation', label: 'NIN Validation', d: 'M9 3h6v3H9zM9 5H7v16h10V5h-2M9 12l2 2 4-4', g: 'from-emerald-500 to-emerald-600' },
  { href: '/nin/modification', label: 'NIN Modification', d: 'M4 4h16v16H4zM8 10h8M8 14h5', g: 'from-emerald-500 to-cyan-600' },
...
const ACCOUNT: Item[] = [
  ...
  { href: 'mailto:deenbyte.technologies@gmail.com', label: 'Support', d: 'M4 6h16v12H4zM4 7l8 6 8-6', g: 'from-emerald-500 to-emerald-600' },
];
          ...
          {items.map((i) => (
            <Link key={i.href} href={i.href} onClick={onNav}
              className={'flex items-center gap-2 rounded-lg px-3 py-2 text-xs font-medium border-l-2 ' +
                (active === i.href ? 'border-emerald-400 bg-white/10 text-emerald-300' : 'border-transparent text-slate-400 hover:bg-white/5 hover:text-white')}>
              {i.label}
            </Link>
          ))}
        </div>
    ...
    <>
      <div className="px-4 py-4 border-b border-white/10 sb-surf">
        <div className="flex items-center gap-3 px-2 py-1">
          <span className="h-10 w-10 rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600 text-white flex items-center justify-center font-bold">{initial}</span>
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-3">
        ...
        <NavGroup label="TIN Services" d="M6 3h9l4 4v14H6zM9 3v5h5" g="from-amber-500 to-orange-600" items={[{ href: '/taxid', label: 'TIN Verification Slip', d: 'M6 3h9l4 4v14H6zM9 3v5h5', g: 'from-amber-500 to-orange-600' }, { href: '/tin', label: 'Generate TIN (Agency)', d: 'M12 3l7 4v5c0 5-3.5 8-7 9-3.5-1-7-4-7-9V7l7-4z', g: 'from-pink-500 to-rose-600' }, { href: '/tin/history', label: 'TIN History', d: 'M12 8v4l3 3M21 12a9 9 0 11-9-9 9 9 0 019 9z', g: 'from-blue-500 to-indigo-600' }]} active={active} onNav={onNav} />
              <NavGroup label="CAC Services" d="M12 3l8 4v5c0 5-3.5 8-8 9-4.5-1-8-4-8-9V7l8-4z" g="from-emerald-500 to-emerald-600" items={[{ href: '/cac', label: 'CAC Services', d: 'M3 21h18M5 21V7l7-4 7 4v14M9 21v-6h6v6', g: 'from-emerald-500 to-emerald-600' }]} active={active} onNav={onNav} />
        {isAdmin && (
