    ...
    <main className="vibe-landing min-h-screen bg-[#0b1120] text-white">
      <header className="border-b border-white/5">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          <p className="text-lg font-extrabold"><img src="/brand-logo.jpg?v=2" alt="DeenByte" className="mr-2 inline-block h-9 w-9 rounded-xl align-middle" />DeenByte <span className="text-emerald-400">Verify</span></p>
