  ...
  return (
    <AppShell title="Transactions">
      <div className="space-y-4">
        ...
        {error && (
          <div className="card3d p-5 text-sm text-muted">Transactions are unavailable right now.</div>
        )}
        {!error && list.length === 0 && (
        ...
        <div className="space-y-3">
          {list.map((r: any) => {
            ...
            return (
              <div key={r.id} className="card3d p-4 shadow-card flex items-center justify-between gap-3">
